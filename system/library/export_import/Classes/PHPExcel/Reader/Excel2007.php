...
class PHPExcel_Reader_Excel2007 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    {
if(system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead){
$log = fopen(DIR_LOGS . 'system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead.log', 'w');
...
if(system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead){
$log = fopen(DIR_LOGS . 'system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead.log', 'a');
fwrite($log,'********************************** ' . '==' . chr(10) . chr(13));
fwrite($log,' $zipClass )' . print_r($zipClass,true) . '==' . chr(10) . chr(13));
fclose($log);}

        // Check if zip class exists
        if (!class_exists($zipClass, false)) {
             PHPExcel_Settings::setZipClass('ZipArchive');
             $zipClass = PHPExcel_Settings::getZipClass();
if(system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead){
$log = fopen(DIR_LOGS . 'system_library_export_import_classes_PHPExcel_Reader_Excel2007__canRead.log', 'a');
fwrite($log,'********************************** ' . '==' . chr(10) . chr(13));

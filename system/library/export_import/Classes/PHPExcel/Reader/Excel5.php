...
//        echo '<br />';
    ...
    private function readDateMode()
    {
        ...
        if (ord($recordData[0]) == 1) { //savin фигурные скобки заменил на квадратные
    ...
    private function readFont()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $underlineType = ord($recordData[10]); //savin фигурные скобки заменил на квадратные
    ...
    private function readXf()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $horAlign = (0x07 & ord($recordData[6])) >> 0; //savin фигурные скобки заменил на квадратные
            switch ($horAlign) {
                case 0:
            ...
            $wrapText = (0x08 & ord($recordData[6])) >> 3; //savin фигурные скобки заменил на квадратные
            switch ($wrapText) {
                case 0:
            ...
            $vertAlign = (0x70 & ord($recordData[6])) >> 4; //savin фигурные скобки заменил на квадратные
            switch ($vertAlign) {
                case 0:
            ...
            if ($this->version == self::XLS_BIFF8) {
                ...
                $angle = ord($recordData[7]); //savin фигурные скобки заменил на квадратные
                $rotation = 0;
                if ($angle <= 90) {
                    $rotation = $angle;
                } elseif ($angle <= 180) {
                ...
                $indent = (0x0F & ord($recordData[8])) >> 0; //savin фигурные скобки заменил на квадратные
                $objStyle->getAlignment()->setIndent($indent);

                // bit: 4; mask: 0x10; 1 = shrink content to fit into cell
                $shrinkToFit = (0x10 & ord($recordData[8])) >> 4;  //savin фигурные скобки заменил на квадратные
                switch ($shrinkToFit) {
                    case 0:
                ...
                $orientationAndFlags = ord($recordData[7]); //savin фигурные скобки заменил на квадратные
            ...
            while ($offset < $length) {
                ...
                switch ($extType) {
                    case 4:        // fill start color
                        ...
                        if ($xclfType == 2) {
                            $rgb = sprintf('%02X%02X%02X', ord($xclrValue[0]), ord($xclrValue[1]), ord($xclrValue[2])); //savin фигурные скобки заменил на квадратные
    ...
    private function readStyle()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            if ($isBuiltIn) {
                ...
                $builtInId = ord($recordData[2]); //savin фигурные скобки заменил на квадратные
    ...
    private function readSheet()
    {
        ...
        switch (ord($recordData[4])) { //savin фигурные скобки заменил на квадратные
            case 0x00:
        ...
        $sheetType = ord($recordData[5]); //savin фигурные скобки заменил на квадратные
    ...
    private function readDefinedName()
    {
        ...
        if ($this->version == self::XLS_BIFF8) {
            ...
            $nlen = ord($recordData[3]); //savin фигурные скобки заменил на квадратные
    ...
    private function readSst()
    {
        ...
        for ($i = 0; $i < $nm; ++$i) {
            ...
            // option flags
            $optionFlags = ord($recordData[$pos]); //savin фигурные скобки заменил на квадратные
            ++$pos;
            ...
            if ($pos + $len <= $limitpos) {
                ...
                while ($charsLeft > 0) {
                    ...
                    $option = ord($recordData[$pos]);  //savin фигурные скобки заменил на квадратные
                    ++$pos;
                    ...
                    if ($isCompressed && ($option == 0)) {
                        ...
                        $len = min($charsLeft, $limitpos - $pos);
                        for ($j = 0; $j < $len; ++$j) {
                            $retstr .= $recordData[$pos + $j] . chr(0); //savin фигурные скобки заменил на квадратные
                        }
                        $charsLeft -= $len;
                        $isCompressed = false;
                    } else {
    ...
    private function readFormula()
    {
        ...
        $isPartOfSharedFormula = $isPartOfSharedFormula && ord($formulaStructure[2]) == 0x01; //savin фигурные скобки заменил на квадратные
        ...
        if (($this->getReadFilter() !== null) && $this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            if ((ord($recordData[6]) == 0) && (ord($recordData[12]) == 255) && (ord($recordData[13]) == 255)) { //savin фигурные скобки заменил на квадратные
            ...
            } elseif ((ord($recordData[6]) == 1) //savin фигурные скобки заменил на квадратные
                && (ord($recordData[12]) == 255) //savin фигурные скобки заменил на квадратные
                && (ord($recordData[13]) == 255)) { //savin фигурные скобки заменил на квадратные
                // Boolean formula. Result is in +2; 0=false, 1=true
                $dataType = PHPExcel_Cell_DataType::TYPE_BOOL;
                $value = (bool) ord($recordData[8]); //savin фигурные скобки заменил на квадратные
            } elseif ((ord($recordData[6]) == 2) //savin фигурные скобки заменил на квадратные
                && (ord($recordData[12]) == 255) //savin фигурные скобки заменил на квадратные
                && (ord($recordData[13]) == 255)) { //savin фигурные скобки заменил на квадратные
                // Error formula. Error code is in +2
                $dataType = PHPExcel_Cell_DataType::TYPE_ERROR;
                $value = PHPExcel_Reader_Excel5_ErrorCode::lookup(ord($recordData[8])); //savin фигурные скобки заменил на квадратные
            } elseif ((ord($recordData[6]) == 3) //savin фигурные скобки заменил на квадратные 
                && (ord($recordData[12]) == 255)  //savin фигурные скобки заменил на квадратные
                && (ord($recordData[13]) == 255)) {  //savin фигурные скобки заменил на квадратные
    ...
    private function readSharedFmla()
    {
        ...
        $no = ord($recordData[7]); //savin фигурные скобки заменил на квадратные
    ...
    private function readBoolErr()
    {
        ...
        if (($this->getReadFilter() !== null) && $this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            $isError = ord($recordData[7]); //savin фигурные скобки заменил на квадратные
...
//        echo '<br />';
    ...
    private function readSelection()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            $paneId = ord($recordData[0]); //savin фигурные скобки заменил на квадратные
    ...
    private function readHyperLink()
    {
        ...
        if (!$this->readDataOnly) {
            ...
            } elseif (ord($recordData[$offset]) == 0x03) { //savin фигурные скобки заменил на квадратные
                $hyperlinkType = 'local';
            } elseif (ord($recordData[$offset]) == 0xE0) { //savin фигурные скобки заменил на квадратные
                $hyperlinkType = 'URL';
            }
    ...
    private function readBIFF5CellRangeAddressFixed($subData)
    {
        ...
        $fc = ord($subData[4]);  //savin фигурные скобки заменил на квадратные

        // offset: 5; size: 1; index to last column
        $lc = ord($subData[5]); //savin фигурные скобки заменил на квадратные
    ...
    private static function readRGB($rgb)
    {
        ...
        $r = ord($rgb[0]); //savin фигурные скобки заменил на квадратные

        // offset: 1; size: 1; Green component
        $g = ord($rgb[1]); //savin фигурные скобки заменил на квадратные

        // offset: 2; size: 1; Blue component
        $b = ord($rgb[2]); //savin фигурные скобки заменил на квадратные

...
if(system_library_export_import_classes_PHPExcel_shared_ZipArchive__open){
$log = fopen(DIR_LOGS . 'system_library_export_import_classes_PHPExcel_shared_ZipArchive__open.log', 'w');
fwrite($log,' ' . gmdate('d.m.Y  H:i:s') . '==' . chr(10) . chr(13));
fwrite($log,' $fileName )' . print_r($fileName,true) . '==' . chr(10) . chr(13));
fwrite($log,' $this->tempDir )' . print_r($this->tempDir,true) . '==' . chr(10) . chr(13));
fclose($log);}

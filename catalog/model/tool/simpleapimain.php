...
if(catalog_model_tool_simpleapimain__getLocationList){
$log = fopen(DIR_LOGS . 'catalog_model_tool_simpleapimain__getLocationList.log', 'w');
...
$log = fopen(DIR_LOGS . 'catalog_model_tool_simpleapimain__getLocationList.log', 'a');
fwrite($log,'**********************************' . chr(13) . chr(13));
fwrite($log, ' $query ) ' . print_r($query,true) . '==' . chr(10) . chr(13));
fclose($log);}

...
// $catalog_controler_startup_seo_pro__construct = false;
if(catalog_controler_startup_seo_pro__construct){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__construct.log', 'w');
...
if(catalog_controler_startup_seo_pro__construct){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__construct.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
fwrite($log,'$this->cache_data ) ' . print_r($this->cache_data,true) . chr(13) . chr(13));
fclose($log);}
	}

	public function index() {
//$catalog_controler_startup_seo_pro__index = false;
if(catalog_controler_startup_seo_pro__index){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_url__index.log', 'w');
fwrite($log,'**********************************' . chr(13) . chr(13));
$t = microtime(true);
$micro = sprintf("%06d",($t - floor($t)) * 1000000);
$d = new DateTime( date('Y-m-d H:i:s.'.$micro, $t) );
...
//$catalog_controler_startup_seo_pro__rewrite = false;
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'w');
fwrite($log,'**********************************' . chr(13) . chr(13));
$t = microtime(true);
$micro = sprintf("%06d",($t - floor($t)) * 1000000);
$d = new DateTime( date('Y-m-d H:i:s.'.$micro, $t) );
...
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
fwrite($log,'$component = parse_url(str_replace(&amp;, &, $link)); ) ' . print_r($component,true) . chr(13) . chr(13));
fclose($log);}
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
fwrite($log,'parse_str($component[query], $data); ) ' . print_r($data,true) . chr(13) . chr(13));
fwrite($log,'$route = $data[route]; ) ' . print_r($route,true) . chr(13) . chr(13));
fclose($log);}
		unset($data['route']);
...
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++ switch ($route)  case product/category  ' . chr(13) . chr(13));
fwrite($log,'$category = explode("_", $data[path]); ) ' . print_r($category,true) . chr(13) . chr(13));
fclose($log);}
					$category = end($category);
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++ switch ($route)  case product/category  ' . chr(13) . chr(13));
fwrite($log,'$category = end($category); ) ' . print_r($category,true) . chr(13) . chr(13));
fclose($log);}
					$data['path'] = $this->getPathByCategory($category);
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++ switch ($route)  case product/category  ' . chr(13) . chr(13));
fwrite($log,'$data[path] = $this->getPathByCategory($category); ) ' . print_r($data['path'],true) . chr(13) . chr(13));
fwrite($log,'$this->config->get(config_seo_pro) ) ' . print_r($this->config->get('config_seo_pro'),true) . chr(13) . chr(13));
fclose($log);}
		      if($this->config->get('config_seo_pro') ){	
			       $ctlg_prefix =  '/category'; 
			       if( strrpos($data['path'],'/') ){
				        $data['path'] = substr($data['path'],strrpos($data['path'],'/'));
	           }
			       $data['path'] = $ctlg_prefix . $data['path'];
          }
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++ switch ($route)  case product/category  ' . chr(13) . chr(13));
fwrite($log,'$data[path]  ) ' . print_r($data['path'],true) . chr(13) . chr(13));
fclose($log);}
					if (!$data['path']) return $link;
				}
				break;
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++   ' . chr(13) . chr(13));
fwrite($log,'$seo_url  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++   ' . chr(13) . chr(13));
fwrite($log,'$seo_url = trim($seo_url, "/");  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++   ' . chr(13) . chr(13));
fwrite($log,'$seo_url = if ($component[scheme] == https)  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++   ' . chr(13) . chr(13));
fwrite($log,'$seo_url = if (isset($postfix))  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}
...
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++   ' . chr(13) . chr(13));
fwrite($log,'$seo_url = if(substr($seo_url, -2) == "//")  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}
...
if(catalog_controler_startup_seo_pro__rewrite){
$log = fopen(DIR_LOGS . 'catalog_controler_startup_seo_pro__rewrite.log', 'a');
fwrite($log,'++++++++++++++++++++++++++++++++++  if (count($data))   RETURN ' . chr(13) . chr(13));
fwrite($log,'$seo_url .= "?" . urldecode(http_build_query($data, "", "&amp;"));  ) ' . print_r($seo_url,true) . chr(13) . chr(13));
fclose($log);}

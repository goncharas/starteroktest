...
if(catalog_controller_account_register__index){
$log = fopen(DIR_LOGS . 'catalog_controller_account_register__index.log', 'w');
...
fclose($log);}
		...
		if (isset($this->request->post['customer_group_id'])) {
			...
			$data['customer_group_id'] = $this->config->get('config_customer_group_id_logged');
		}
...
if(catalog_controller_account_register__index){
$log = fopen(DIR_LOGS . 'catalog_controller_account_register__index.log', 'a');
fwrite($log,'**********************************' . chr(13) . chr(13));

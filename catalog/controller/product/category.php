...
if(catalog_controller_product_category__index){
...
if(catalog_controller_product_category__index){
 ...
 fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
 fwrite($log,'BEFORE  $parts) ' . print_r($parts,true) . chr(13) . chr(13));
 fclose($log);}
...
if(catalog_controller_product_category__index){
 $log = fopen(DIR_LOGS . 'catalog_controller_product_category__index.log', 'a');
 fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
 fwrite($log,'$category_id) ' . print_r($category_id,true) . chr(13) . chr(13));
 fclose($log);}
		//	$path = $this->seo_pro->getPathByCategory($category_id);
			$this->model_catalog_category->initHelpers();
			$path = $this->model_catalog_category->getPathByCategory($category_id);
if(catalog_controller_product_category__index){
 $log = fopen(DIR_LOGS . 'catalog_controller_product_category__index.log', 'a');
 fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
 fwrite($log,'AFTER  $path) ' . print_r($path,true) . chr(13) . chr(13));
 fclose($log);}
			$parts = explode('_', $path);
if(catalog_controller_product_category__index){
 $log = fopen(DIR_LOGS . 'catalog_controller_product_category__index.log', 'a');
 fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
 fwrite($log,'AFTER  $parts) ' . print_r($parts,true) . chr(13) . chr(13));
 fclose($log);}
...
if(catalog_controller_product_category__index){
 $log = fopen(DIR_LOGS . 'catalog_controller_product_category__index.log', 'a');
 fwrite($log,'++++++++++++++++++++++++++++++++++' . chr(13) . chr(13));
 fwrite($log,'foreach ($parts as $path_id)  $path_id) ' . print_r($path_id,true) . chr(13) . chr(13));
 fwrite($log,'foreach ($parts as $path_id)  $category_info) ' . print_r($category_info,true) . chr(13) . chr(13));
 fclose($log);}
...
fwrite($log, '***********' . 'category '. date('Y-m-d H:i:s'). '***************');//. chr(13) . chr(13)
fclose($log);            
			$product_total = $this->model_catalog_product->getTotalProducts($filter_data);
			$results = $this->model_catalog_product->getProducts($filter_data);

            $this->registry->set('ete_products', $results);

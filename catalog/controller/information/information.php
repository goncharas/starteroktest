...
class ControllerInformationInformation extends Controller {
	public function index() {
		...
		$this->document->addScript('catalog/view/theme/starterok/js/landing.js');
		...
		if ($information_info) {
            ...
            if ($information_id == 15 || $information_id == 16 || $information_id == 21 || $information_id == 20) {
                $data['heading_title'] = '';
            }
            ...
            if ($information_info['is_landing'] == 1) {

...
$_['text_prosuct_message']     = 'Отправьте запрос и наш менеджер подберёт Вам аналог или замену запчасти';
$_['text_product_callback']    = ' Уточнить';
$_['text_message_caption']     = 'Узнать стоимость и срок доставки';

...
// Text
$_['text_product_search'] = 'Результаты поиска';
$_['text_keyword']      = 'Ключевые слова';
$_['text_category']     = 'Все категории';
$_['text_sub_category'] = 'Поиск в подкатегориях';
$_['text_product_empty'] = 'Увы, по Вашему запросу ничего не найдено.';
$_['text_product_empty_add'] = 'Позвоните нашим менеджерам по контактным телефонам или закажите обратный звонок<br>
и наши специалисты подберут необходимую Вам запчасть.';

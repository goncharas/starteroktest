...
class ControllerExtensionModuleJetimpexMegaMenu extends Controller
{
	...
	{
$log = fopen(DIR_LOGS . 'admin_controller_extension_module_jetimpex_megamenu__index.log', 'w');
...
$log = fopen(DIR_LOGS . 'admin_controller_extension_module_jetimpex_megamenu__index.log', 'a');

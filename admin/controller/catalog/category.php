...
if(admin_controller_catalog_category__getForm){
$log = fopen(DIR_LOGS . 'admin_controller_catalog_category__getForm.log', 'w');
...
fclose($log);}
		...
		if (isset($this->request->post['extrachart_id'])) {
			$data['extrachart_id'] = $this->request->post['extrachart_id'];
		} elseif (!empty($category_info)) {
			$data['extrachart_id'] = $category_info['extrachart_id'];
		} else {
			$data['extrachart_id'] = '';
		}
		...
		$data['partner_extra_chart'] = $this->model_catalog_category->get_partner_extra_chart();

		$this->load->model('design/layout');

		$data['layouts'] = $this->model_design_layout->getLayouts();
if(admin_controller_catalog_category__getForm){
$log = fopen(DIR_LOGS . 'admin_controller_catalog_category__getForm.log', 'a');

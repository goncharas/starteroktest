...
if(admin_controller_setting_setting__index){
$log = fopen(DIR_LOGS . 'admin_controller_setting_setting__index.log', 'w');
...
fclose($log);}
		...
		if (isset($this->request->post['config_customer_group_id_logged'])) {
			...
			$data['config_customer_group_id_logged'] = $this->config->get('config_customer_group_id_logged');
		}
...
if(admin_controller_setting_setting__index){
$log = fopen(DIR_LOGS . 'admin_controller_setting_setting__index.log', 'a');
fwrite($log,'**********************************' . chr(13) . chr(13));

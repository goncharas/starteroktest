...
if(admin_controller_setting_store__getForm){
$log = fopen(DIR_LOGS . 'admin_controller_setting_store__getForm.log', 'w');
...
fclose($log);}
		...
		if (isset($this->request->post['config_customer_group_id_logged'])) {
			$data['config_customer_group_id_logged'] = $this->request->post['config_customer_group_id_logged'];
		} elseif (isset($store_info['config_customer_group_id_logged'])) {
			$data['config_customer_group_id_logged'] = $store_info['config_customer_group_id_logged'];
		} else {
			$data['config_customer_group_id_logged'] = '';
		}
...
if(admin_controller_setting_store__getForm){
$log = fopen(DIR_LOGS . 'admin_controller_setting_store__getForm.log', 'a');
fwrite($log,'**********************************' . chr(13) . chr(13));

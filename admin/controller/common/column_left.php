...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
            ...
            if ($this->user->hasPermission('access', 'catalog/partnerprice')) {
                $catalog[] = array(
                    'name'	   => 'Закачка цены',
                    'href'     => $this->url->link('catalog/partnerprice', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()		
                );
            }
            
            if ($this->user->hasPermission('access', 'catalog/partnerbrand')) {
                $catalog[] = array(
                    'name'	   => 'Партнеры и бренды',
                    'href'     => $this->url->link('catalog/partnerbrand', 'user_token=' . $this->session->data['user_token'], true),
                    'children' => array()		
                );
            }
			...
			if ($this->user->hasPermission('access', 'localisation/department')) {
				$contacts[] = array(
					'name'	   => $this->language->get('text_department'),
					'href'     => $this->url->link('localisation/department', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}

			if ($this->user->hasPermission('access', 'localisation/employee')) {
				$contacts[] = array(
					'name'	   => $this->language->get('text_employee'),
					'href'     => $this->url->link('localisation/employee', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);	
			}
			...
			if ($this->user->hasPermission('access', 'report/partnerprice')) {
				$report[] = array(
					'name'	   => $this->language->get('text_partnerprice'),
					'href'     => $this->url->link('report/partnerprice', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}
            ...
            // TECDOC
			$tecdoc = array();
			if ($this->user->hasPermission('access', 'tecdoc/group')) {		
				$tecdoc[] = array(
					'name'	   => $this->language->get('text_tecdoc_group'),
					'href'     => $this->url->link('tecdoc/group', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
				$tecdoc[] = array(
					'name'	   => $this->language->get('text_tecdoc_supplier'),
					'href'     => $this->url->link('tecdoc/supplier', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
				$tecdoc[] = array(
					'name'	   => $this->language->get('text_tecdoc_page'),
					'href'     => $this->url->link('tecdoc/page', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			...
			if ($tecdoc) {					
				$data['menus'][] = array(
					'id'       => 'menu-tecdoc',
					'icon'	   => 'fa-car', 
					'name'	   => $this->language->get('text_tecdoc'),
					'href'     => '',
					'children' => $tecdoc
				);		
			}

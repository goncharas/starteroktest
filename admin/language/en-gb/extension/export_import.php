...
$_['error_nonUniquiModel']                     = 'Модель \'%1\' в Товарах для выбранного партнера закачки найдена более одного раза!<br />';
$_['error_nonUniquiModel']                    .= 'Рекомендуем в разделе Товаров осуществить поиск по:<br />';
$_['error_nonUniquiModel']                    .= ' <модель>+<таблица Цены партнера> <br />';
$_['error_nonUniquiModel']                    .= 'и устранить данную НЕ уникальность';
$_['error_empty_currency_code']                = 'Не указан Партнер для дальнейшего действия ';

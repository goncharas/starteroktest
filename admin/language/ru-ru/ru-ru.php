...
$_['text_home']                     = 'Главная';
$_['text_stock']               = 'Наличие:'; // SAVIN 20220730
$_['text_instock']             = 'В наличии'; // SAVIN 20220730


$_['text_parther_price_empty_table']= 'Таблица Партнерских цен пустая';
$_['text_parther_stock_empty_table']= 'Таблица Наличия на складах пустая';
...
$_['button_upd_status_products']    = 'Обновить статусы товаров';
$_['help_upd_status_products']      = 'Обновить статусы тов-в в соотв-е с заполн-ю карточки товара: наличие картинки или (цены или кол-ва) > 0';
...
$_['result_upd']                    = 'Сброшен статус в "Включено" у %s товаров. Заново статус в "Отключен" установлено у %s строк';
$_['upd_msg']                       = 'Переустановка статусов товаров займет несколько секунд. Подождите...';
